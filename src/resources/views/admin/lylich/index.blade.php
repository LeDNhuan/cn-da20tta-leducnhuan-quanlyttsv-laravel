        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{ route('sinhvien.index') }}">Quản lý sinh viên</a></li>
                            ...
                            <div class="row">
                                    ...
                                    @if (isset($lylich) && is_object($lylich))
                                        <div class="col-md-3">
                                            ...
                                            <a href="{{ route('lylich.gdsua', $sinhvien->MSSV) }}" class="btn btn-success" style="width: 120px"><i class="fa fa-edit"></i> Sửa</a>
                                        </div>
                                    @else
                                        <div class="col-md-3">
                                            <a href="{{ route('lylich.gdthem', $sinhvien->MSSV) }}" class="btn btn-primary" style="width: 120px">Thêm</a>
                                            <a href="{{ route('lylich.gdsua', $sinhvien->MSSV) }}" class="btn btn-success" style="width: 120px" disabled>Sửa</a>
                                        </div>
                                    @endif       
                                </div>  
                        </div>
