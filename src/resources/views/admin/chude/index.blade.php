                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <a href="{{ route('chude.gdthem') }}" class="btn btn-primary" style="width: 110px"><i class="fa fa-plus"></i> Thêm</a>
                                        &nbsp;
                                        <a href="" class="btn btn-danger" style="width: 110px"><i class="fa fa-trash"></i> Xóa</a>
                                    </div>
                                </div>                               
                            </div>
                            <!-- /.card-header -->
