                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-9">
                                        <h3 class="card-title" style="margin-top: 10px">Bài đăng chưa duyệt</h3>
                                    </div>
                                    {{-- <div class="col-md-3">
                                        ...
                                        {{-- @if (isset($giangvien) && is_object($giangvien)) --}}
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 120px">
                                                    <form action="{{ route('baidang.xoa', $bd->id) }}" method="post">
                                                        <a href="{{ route('baidang.duyet', $bd->id) }}" class="btn btn-success"><i class="fa fa-check"></i></a>                                                        
                                                        @method('DELETE')
                                                        @csrf
