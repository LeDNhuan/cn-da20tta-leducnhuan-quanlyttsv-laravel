                                ...
                                <form action="{{ route('sinhvien.sua', $sinhvien->MSSV) }}" method="POST">
                                    ...
                                    <div class="card-body table-bordered">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{ $sinhvien->MSSV }}" name="MSSV" placeholder="Nhập MSGV">
                                        </div>
                                        <div class="form-group">
                                            <label for="HoGV">Họ SV</label>
                                            <input type="text" class="form-control" value="{{ $sinhvien->HoSV }}" name="HoSV" placeholder="Nhập họ SV">
                                        </div>
                                        <div class="form-group">
                                            <label for="TenSV">Tên SV</label>
                                            <input type="text" class="form-control" value="{{ $sinhvien->TenSV }}" name="TenSV" placeholder="Nhập tên GV">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" value="{{ $sinhvien->NgaySinh }}" name="NgaySinh" placeholder="Nhập ngày sinh">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select form-control-border border-width-2" name="TinhTrang">
                                                ...
                                                <option>Học</option>
                                                <option>Cảnh báo học vụ lần 1</option>
                                                <option>Cảnh báo học vụ lần 2</option>
                                                <option>Buộc thôi học</option>
                                                <option>Nghỉ học</option>
                                                <option>Bảo lưu</option>
                                                <option>Xóa tên</option>
