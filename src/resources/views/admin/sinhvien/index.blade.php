                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <select class="custom-select form-control-border border-width-2" name="MaLop" style="width: 270px;" onchange="window.location.href=this.value;">
                                            <option selected disabled>Xem sinh viên theo lớp</option>
                                            @foreach ($lop as $lp)
                                                <option id="selectLop" value= "{{ route('xemtheolop.index', $lp->MaLop) }}">{{ $lp->TenLop }}</option>
                                            @endforeach   
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        <a href="{{ route('sinhvien.gdthem') }}" class="btn btn-primary" style="width: 110px">Thêm</a>
                                        &nbsp;
