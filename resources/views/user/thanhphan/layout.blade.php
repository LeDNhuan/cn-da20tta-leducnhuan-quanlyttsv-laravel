                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Chương trình đào tạo<span class="caret"></span></a>
                                    <ul class="dropdown-menu animated zoomIn">
                                        @foreach ($madt as $dt)    
                                        <li value="{{ $dt->MaDaoTao }}"><a href="">{{ $dt->SoQuyetDinh }}</a></li>
                                        @endforeach 
                                    </ul>
