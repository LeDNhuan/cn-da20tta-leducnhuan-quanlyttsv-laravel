                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ route('covan.index') }}">Quản lý cố vấn</a></li>
                            <li class="breadcrumb-item active">Cập nhật trạng thái cố vấn</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title" style="margin-top: 10px">Cập nhật trạng thái cố vấn</h2>                               
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <!-- form start -->
                                <form action="{{ route('covan.sua', $covan->MaGV, $covan->MaLop) }}" method="POST">
                                    @method('PUT')
                                    @csrf
