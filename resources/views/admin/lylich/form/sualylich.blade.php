                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <!-- form start -->
                                <form action="{{ route('sinhvienq.sua', $sinhvien->MaGV) }}" method="POST">
                                    @method('PUT')
                                    @csrf
                                    <div class="card-body table-bordered">
                                        <div class="form-group">
                                            <label for="MaGV">MSGV</label>
                                            <input type="text" class="form-control" value="{{ $sinhvien->MaGV }}" name="MaGV" placeholder="Nhập MSGV">
                                        </div>
                                        <div class="form-group">
                                            <label for="HoGV">Họ GV</label>
                                            <input type="text" class="form-control" value="{{ $sinhvien->HoGV }}" name="HoGV" placeholder="Nhập họ GV">
                                        </div>
                                        <div class="form-group">
                                            <label for="TenGV">Tên GV</label>
                                            <input type="text" class="form-control" value="{{ $sinhvien->TenGV }}" name="TenGV" placeholder="Nhập tên GV">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        &nbsp;
                                        <a href="{{ route('sinhvienq.index') }}" type="submit" class="btn btn-danger" style="width: 100px">Trở lại</a>
                                    </div>
                                </form>
                            </div>
                        </div>
